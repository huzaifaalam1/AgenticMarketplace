          ...
          <div key={supplier.id} className="bg-amber-100 rounded-3xl shadow-md p-6 flex flex-col gap-3 hover:scale-[1.02] transition">
            ...
            <div className="mt-4 flex gap-2">
              {sentInvites.includes(supplier.id) ? (
                <button
                  disabled
                  className="flex-1 bg-gray-300 px-4 py-2 rounded-xl cursor-not-allowed"
                >
                  Invite Sent
                </button>
              ) : (
                <button
                  ...
                  className="flex-1 bg-amber-400 hover:bg-amber-500 px-4 py-2 rounded-xl"
                >
                  Invite to Deal
                </button>
              )}
              ...
              <button
                onClick={() => startChat(supplier.user_id || supplier.organizations?.owner_id)}
